...
export default function CreateProcesso({toggleSelf, refresh}) {
  ...
  const getStatus = () => {
    api.post("/status/get",{descricao: ""}).then(result => {
  ...
  return (
    <div className="modal-container"  onMouseDown={(e) => {e.target.className === "modal-container" && toggleSelf()}}>
      <form
        action=""
        className="form"
        onSubmit={(e) => {
      ...
      >
        ...
        {credor ? (
          ...
          <div className="form-item">
            ...
            />
            <div className="select-credor" style={{ position: "relative" }}>
              <div
                className="select-credor-list"
        ...
        <div className="form-item">
          ...
          <select name="status" id="status" value={status} onChange={(e) => {setStatus(e.target.value)}}>
            {statusList && statusList.map((curr, index) => {
              return <option value={curr.descricao} key={index}>{curr.descricao}</option>
            })}
          </select>
        </div>
        <div className="form-item">
